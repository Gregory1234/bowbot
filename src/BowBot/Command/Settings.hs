...
getSettingToSet "beststreak" (senseFromEither -> Just b) = Right ("bestStreak", fromSense b, \s -> s {sBestStreak = b})
getSettingToSet "currentstreak" (senseFromEither -> Just b) = Right ("currentStreak", fromSense b, \s -> s {sCurrentStreak = b})
getSettingToSet "bestdailystreak" (senseFromEither -> Just b) = Right ("bestDailyStreak", fromSense b, \s -> s {sBestDailyStreak = b})
